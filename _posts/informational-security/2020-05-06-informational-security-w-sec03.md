...
2. `SPN 구조(Substitution Permutation Network)`
    ...
    ![SPN 구조](http://dev-ujin.github.io/assets/res/informational-security/spn-structure.png)
...
1. `동기식 스트림 암호` : K 스트림은 P 혹은 C 스트림과 **독립적**으로 생성되고 사용됨
    ...
    2. `귀환 시프트 레지스터(FSR, Feedback Shift Register)`
        ...
        ![FSR구조](http://dev-ujin.github.io/assets/res/informational-security/fsr.png)
    3. `선형 귀환 시프트 레지스터(LFSR, Linear Feedback Shift Register)`
        - **HW로 쉽게 구현**
        - **많은 스트림 암호가 LFSR를 이용**

        ![LFSR구조](http://dev-ujin.github.io/assets/res/informational-security/lfsr.png)
