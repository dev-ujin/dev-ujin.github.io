...
|:---:|:---:|:---:|:---:|:---:|
|PSEV 방식|전자투표기|상|하|이미 정해져있는 기존 투표소에서 투표기를 이용하여 투표를 실시한 후 전자식 투표기록장치를 개표소로 옮겨와 컴퓨터로 결과를 집계|
|Kiosk 방식|전자투표기|중|중|정해지지 않은 임의 투표소에서 전자투표, 투표소와 개표소를 온라인으로 연결하여 투표결과는 자동적으로 개표소로 전송되어 자동적으로 집계|
|REV 방식|모바일 디지털TV, PC|하|상|가정이나 직장에서 인터넷을 통하여 투표, 투표 결과가 개표소나 중앙관리센터로 보내져 자동적으로 집계|
