---
layout: post
title:  "Eclipse와 Tomcat연동 - HTTP Status 404"
...
![http status 404](https://dev-ujin.github.io/assets/res/tomcat-404-05.png){: .img}
...
![location 변경](https://dev-ujin.github.io/assets/res/tomcat-404-01.png){: .img}
2. 다시 Servers탭에 추가한 `Server명 더블클릭 > Server Locations > Use Tomcat Installation`을 선택
...
![tomcat]](https://dev-ujin.github.io/assets/res/tomcat-404-04.png){: .img}
...
![index파일의 경로](https://dev-ujin.github.io/assets/res/tomcat-404-02.png){: .img}
...
### 반갑다! Hello World!
![Hello World](https://dev-ujin.github.io/assets/res/tomcat-404-03.png){: .img}
