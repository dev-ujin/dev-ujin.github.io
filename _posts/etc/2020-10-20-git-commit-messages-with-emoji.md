...
## 문제 발생...&#x1F644;
![git-commit-messages-with-emoji-01](../../assets/res/git-github/git-commit-messages-with-emoji-01.png)
본문 왼쪽에 Margin이 생기고 폰트가 모두 흰색으로 바뀌는 현상이 발생했다. 디자인 에러인가 싶어서 css파일을 열심히 봤지만 다른 포스트에서는 문제가 발생하지 않았고 구글링을 해본 결과

![git-commit-messages-with-emoji-02](../../assets/res/git-github/git-commit-messages-with-emoji-02.png)
